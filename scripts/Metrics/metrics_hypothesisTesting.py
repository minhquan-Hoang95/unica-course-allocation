...
def areGroupDifferent(vectors:pd.DataFrame, metrics:list[PARETO_FUNCTION], groupCol:str|int = "track") -> dict[str,Any]:
    ...
    results["Kruskal"] = {"Desc.":"Kruskal-Wallis H test for independent samples and groups.","H0":"All the groups have the same distribution.", "H1":"At least one group have different distribution"}
    results["MannWhitneyU"] = {"Desc.":"Mann-Whitney U test (Wilcoxon rank-sum test).","H0":"The two groups have the same distribution.", "H1":"The distribution of group 1 is stochastically greater than the distribution of group 2, i.e. group 1 have generally higher values than group 2.", "Alt.":"greater"}
